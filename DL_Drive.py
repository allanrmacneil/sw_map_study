...
def DL_Drive(fname): # download a file from my google drive
    ...
    if not os.path.exists(fname):
        ...
        url_dict = {'omni_2006_21.hdf': 'https://drive.google.com/uc?id=1qKdjrF-VQ9wy-Xp1r1X-8OfgSmQV4zWk',
                    'Matched_crossings_2006_2020_update.h5':'https://drive.google.com/uc?id=1Lt2456o9zGImAK8hRrvG-nORfXN0ml9U', 
                    'HCSGONG_MAPs.hdf':'https://drive.google.com/uc?id=1T_oP3DIva9qHiKdVxG5MPbfCG40Q4tNm', 
                    'dphi_4d_array_update.nc':'https://drive.google.com/uc?id=1WDQEuqHmINuTgkqocI6a96GC5BZexQbJ', 
                   ...
                   'Matched_crossings_2006_2020_study.h5': 'https://drive.google.com/file/d/1WDtswUAmB_CQnoVwJnw1O_xuGb1qpmH-',
                   'dphi_4d_array_study.nc': 'https://drive.google.com/uc?id=1DNn9eSAs0927jDkiJFSrXdeUYvZpQc-Q' }
        url = url_dict[fname] 
